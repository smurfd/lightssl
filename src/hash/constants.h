...
#define SHA_AddLength(c, l, t)(t = c->Length_Low,\
  c->Corrupted = ((c->Length_Low += l) < t) &&\
  (++c->Length_High == 0) ? shaInputTooLong : (c)->Corrupted)
...
u08 masks[8]   = {0x00, 0x80, 0xC0, 0xE0, 0xF0, 0xF8, 0xFC, 0xFE};
u08 markbit[8] = {0x80, 0x40, 0x20, 0x10, 0x08, 0x04, 0x02, 0x01};
