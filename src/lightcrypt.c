...
void lightcrypt_point_mul(bigint_t *key, bigint_t *point1, bigint_t *point2, bigint_t **ret1, bigint_t **ret2) {
  ...
  if (key->neg == true) {
    ...
    big_set_m(2, &po1, &po2);
    key->neg = false;
    //lightcrypt_point_neg(point1, point1, &po1);
    //lightcrypt_point_neg(point2, point2, &po2);
