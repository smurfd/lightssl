...
int main(int argc, char **argv) {
  ...
  if (argc == 2 && argv) {
    if (strcmp(argv[1], "server") == 0) {
      ...
      big_set_2("1234", &ac);
      big_set_2("2173987128397129837129837128937129837129837129837129837129321739871283971298371298371289371298371298371298371298371293", &ad);
      big_get_2(ad, cc);
      big_get_2(ac, cc);
      ...
      // Sanity checks
      big_set_2("21739871283971298371298371289371298371298371298371298371293",
          &ac);
      big_assert_str("2173987128397129837129837128937129837129837129837129"\
          "8371293", &ac);

      big_set_2("000123000", &ac);
      ...
      // Addition tests
      big_set_2("11111111111111111111111111111111111111111111111111111111111000",
          &ac);
      big_set_2("33333333333333333333333333333333333333333333333333333333333789",
          &ad);
      big_add_2(ac, ad, &a1);
      big_get_2(a1, cc);
      ...
      big_set_2("922221322222222222222225555555555555555555555555555555555555555"\
          "5555555555555555555555555222212", &ac);
      big_set_2("111111191112312312311111231231313131323442323423422321313156434"\
          "5654345643456543", &ad);
      big_add_2(ac, ad, &a1);
      ...
      big_set_2("214213091810068356490404658162027412465979525019828343314523084"\
          "9083913577835915686366844006617905592092527870833662447286333080721"\
          "3114639693592192652215296", &ac);
      big_set_2("309533158886756081306558107419546609056284391055396614233847499"\
      ...
      big_set_2("103382526560188488028939012105769917025147424782696844777714231"\
          "4672936145", &ac);
      big_set_2("658458585704117920939883059739518616123144451775691193326701722"\
          "12419499", &ad);
      big_sub_2(ac, ad, &a1);
      big_assert_str("96797940703147308819540181508374730863915980264939932844"\
          "4472142460516646", &a1);

      big_set_2("437703505986056238846885350006344429013751625372343806962268577"\
          "70", &ac);
      big_set_2("998689668015619845290232924195546972680041504057103240236666837",
          &ad);
      big_sub_2(ac, ad, &a1);
      ...
      big_set_2("65341020041517", &ac);
      big_set_2("504510691", &ad);
      big_div_2(ac, ad, &a1);
      ...
      big_set_2("372865034438889165706507940964903653553438428825000546936450726"\
          "39621059063465", &ac);
      big_set_2("2", &ad);
      big_div_2(ac, ad, &a1);
      ...
      big_set_2("37286503443888916570650794096490365355343842882500054693645072639621059063465", &ac);
      big_set_2("2", &ad);
      big_div_2(ac, ad, &a1);
      big_assert_str("18643251721944458285325397048245182677671921441250027346822536319810529531732", &a1);

      big_set_2("213126621294744966540523670831272617567382343028847973123306705"\
          "4703025450131593775345799632714362864292670109702312040306070201792"\
          "271107175502373632466160", &ac);
      big_set_2("115792089237316195423570985008687907853269984665640564039457584"\
          "007908834671663", &ad);
      big_div_2(ac, ad, &a1);
      big_assert_str("18405974250791985306898387292513446207790260853623256697"\
          "871975478881952846046", &a1);

      // this test doesnt work, gets 0?
//      big_set_2("300923130364674303566064152685592960036419222958287034092357419", &ac);
//      big_set_2("521205221864955451187670066261363906193068031158944893620680", &ad);
//      big_div_2(ac, ad, &a1);
//      big_get_2(a1, cc);
//      printf("a1=%s\n", cc);
//      big_assert_str("577", &a1);

      // Below 3 tests causes memory issues, to many numbers?

//      big_set_2("977831680815396008051953620868336321350460074412926936453701305"\
...
//
//      big_set_2("404251716026950615354170846130636321176736173869816767172198188"\
...
//
//      big_set_2("", &ac);
//      big_set_2("115792089237316195423570985008687907853269984665640564039457584007908834671663", &ad);
//      big_div_2(ac, ad, &a1);
//      big_assert_str("", &a1);
