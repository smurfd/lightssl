  ...
  if (argc == 2 && argv) {
    if (strcmp(argv[1], "server") == 0) {
      ...
      big_set("30953315888675608130655810741954660905628439105539661"\
           ...
           "17241307384", &ad);
      big_sub(ac, ad, &a1);
      assert(strcmp("-30953315888675608130655810741954660905628439105"\
          "539661423384749908067162189323731611759375415624790579078"\
          "548903540539639959382186045156535086423247060960107574148"\
          "451814423342920841723492670546721115536279639125983579257"\
          "07898558454037", big_get(a1)) == 0);
