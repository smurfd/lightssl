...
int main() {
  int err = lighthash_hash(TEST9_512, length(TEST9_512),
  1, 3, 0x80, 0, 0, "32BA76FC30EAA0208AEB50FFB5AF1864FDBF17902A4DC0A682C61FCEA6"
  "D92B783267B21080301837F59DE79C6B337DB2526F8A0A510E5E53CAFED4355FE7C2F1", 64);
  assert(err == 1);
  printf("OK\n");
  return 0;
}
